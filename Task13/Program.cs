...
while(copynumber / 10 != 0)
{
  ...
  // цикл подсчета знаков в заданном числе, как для положительных, так и для отрицательных чисел.
}
...
int first3numbers = number / lastnumbers;   

int thirdnumber = first3numbers % 10;  // Вуаля - остаток от деления на 10 первых трех цифр- наше искомое число.  В целом доволен этим кодом, но думаю можно было сделать проще и быстрее, буду благодарен Вам за обратную связь.
